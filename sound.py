...
class Sound:
    def __init__(self):
        ...
        #
        self.player_attack = {
            ID.KNIFE_0: self.load('w_knife.mp3', volume=0.6),
            ID.PISTOL_0: self.load('w_pistol.wav', volume=0.2),
            ID.RIFLE_0: self.load('w_rifle.ogg', volume=0.2),
            ID.ROCKET_0: self.load('rocket.wav', volume=0.2),
            ID.SHOTGUN_0: self.load('shotgun.wav', volume=0.5),
            ID.DBSHOTGUN_0: self.load('doublebarrel.mp3', volume=0.8)
        }
        #
        ...
        #
        self.open_door = self.load('door.oga', volume=1.0)
        self.powerdown = self.load('powerdown.wav')
        #
        self.pick_up = {
            ID.SUPERORB: self.load('powerup.wav'),
            ID.AMMO: self.load('p_ammo.ogg'),
            ID.ROCKETPACK: self.load('p_ammo.ogg'),
            ID.SHELLPACK: self.load('p_ammo.ogg'),
            ID.MED_KIT: self.load('p_med_kit.mp3'),
            ID.REDKEY: self.load('p_key.wav'),
            ID.BLUEKEY: self.load('p_key.wav'),
            ID.YELLOWKEY: self.load('p_key.wav'),
        }
        self.pick_up[ID.PISTOL_ICON] = self.pick_up[ID.AMMO]
        self.pick_up[ID.RIFLE_ICON] = self.pick_up[ID.AMMO]
        #
        self.enemy_attack = {
            ID.SOLDIER_BLUE_0: self.load('n_soldier_attack.wav', volume=0.8),
            ID.SOLDIER_BROWN_0: self.load('n_soldier_attack.ogg', volume=0.4),
            ID.RAT_0: self.load('n_rat_attack.ogg', volume=0.2),
        }
        #
        self.spotted = {
            ID.SOLDIER_BLUE_0: self.load('n_soldier_spotted.wav', volume=1.0),
            ID.SOLDIER_BROWN_0: self.load('n_brown_spotted.ogg', volume=0.8),
            ID.RAT_0: self.load('n_rat_spotted.ogg', volume=0.5),
        }
        #
        self.death = {
            ID.SOLDIER_BLUE_0: self.load('n_blue_death.wav', volume=0.8),
